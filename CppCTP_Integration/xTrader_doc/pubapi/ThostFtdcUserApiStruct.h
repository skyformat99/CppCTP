...
struct CThostFtdcExchangeField
{
	...
	///虚拟交易所标志
	TThostFtdcBoolType	IsVirtualExchange;
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///不能订阅行情
	TThostFtdcBoolType	IsNoMarket;
};
...
struct CThostFtdcTraderField
{
	...
	TThostFtdcPasswordType	Password;
	///报盘类型
	TThostFtdcOfferTypeType	OfferType;
	///安装数量
	TThostFtdcInstallCountType	InstallCount;
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///是否需要查询合约
	TThostFtdcBoolType	NoQryInstrument;
	///是否需要查询手续费率
	TThostFtdcBoolType	NeedQryCommissionRate;
};
...
struct CThostFtdcInvestorPositionField
{
	...
	///策略编号
	TThostFtdcStrategyIDType	StrategyID;
};
...
struct CThostFtdcInstrumentCommissionRateField
{
	...
	///撤单手续费
	TThostFtdcRatioType	CancelOrderRatio;
};
...
struct CThostFtdcOrderField
{
	...
	TThostFtdcStrategyIDType	StrategyID;
	///前置编号
	TThostFtdcFrontIDType	UserFrontID;
	///会话编号
	TThostFtdcSessionIDType	UserSessionID;
	///报单引用
	TThostFtdcOrderRefType	UserOrderRef;
};
...
///交易策略
struct CThostFtdcTradingStrategyField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
	...
	TThostFtdcStrategyIDType	StrategyID;
	///策略名称
	TThostFtdcStrategyNameType	StrategyName;
	///策略类型
	TThostFtdcStrategyTypeType	StrategyType;
	///是否活跃
	TThostFtdcBoolType	IsActive;
	///空头是否活跃
	TThostFtdcBoolType	IsShortActive;
	///多头是否活跃
	TThostFtdcBoolType	IsLongActive;
	///第一腿合约
	TThostFtdcInstrumentIDType	Leg1;
	///第二腿合约
	TThostFtdcInstrumentIDType	Leg2;
	///第一腿合约买卖方向
	TThostFtdcDirectionType	Leg1Direction;
	///第二腿合约买卖方向
	TThostFtdcDirectionType	Leg2Direction;
	///做空开仓价差
	TThostFtdcPriceType	ShortOpenSpread;
	///做空平仓价差
	TThostFtdcPriceType	ShortCloseSpread;
	///做多开仓价差
	TThostFtdcPriceType	LongOpenSpread;
	///做多平仓价差
	TThostFtdcPriceType	LongCloseSpread;
	///有效行情的时间差
	TThostFtdcMillisecType	ValidMDTime;
	///做空价差算法
	TThostFtdcSpreadAlgoType	ShortSpreadAlgo;
	///做多价差算法
	TThostFtdcSpreadAlgoType	LongSpreadAlgo;
	///第一腿空头开仓挂价算法
	TThostFtdcSpreadAlgoType	Leg1ShortOpenPriceAlgo;
	///第一腿空头平仓挂价算法
	TThostFtdcSpreadAlgoType	Leg1ShortClosePriceAlgo;
	///第一腿多头开仓挂价算法
	TThostFtdcSpreadAlgoType	Leg1LongOpenPriceAlgo;
	///第一腿多头平仓挂价算法
	TThostFtdcSpreadAlgoType	Leg1LongClosePriceAlgo;
	///第二腿空头开仓挂价算法
	TThostFtdcSpreadAlgoType	Leg2ShortOpenPriceAlgo;
	///第二腿空头平仓挂价算法
	TThostFtdcSpreadAlgoType	Leg2ShortClosePriceAlgo;
	///第二腿多头开仓挂价算法
	TThostFtdcSpreadAlgoType	Leg2LongOpenPriceAlgo;
	///第二腿多头平仓挂价算法
	TThostFtdcSpreadAlgoType	Leg2LongClosePriceAlgo;
	///价差滑点
	TThostFtdcTickAmountType	SpreadSlippage;
	///第一腿等待滑点
	TThostFtdcTickAmountType	Leg1Slippage;
	///第二腿等待滑点
	TThostFtdcTickAmountType	Leg2Slippage;
	///自由参数
	TThostFtdcTickAmountType	FreeParam;
	///交易手数
	TThostFtdcVolumeType	TotalVolume;
	///交易份数
	TThostFtdcVolumeType	SingleVolume;
	///第一腿合约报价Tick值
	TThostFtdcPriceType	Leg1PriceTick;
	///第二腿合约报价Tick值
	TThostFtdcPriceType	Leg2PriceTick;
	///第一腿空头持仓
	TThostFtdcVolumeType	Leg1ShortPosition;
	///第二腿多头持仓
	TThostFtdcVolumeType	Leg2LongPosition;
	///第一腿多头持仓
	TThostFtdcVolumeType	Leg1LongPosition;
	///第二腿空头持仓
	TThostFtdcVolumeType	Leg2ShortPosition;
	///策略算法代码
	TThostFtdcStrategyAlgoIDType	StrategyAlgoID;
	///交易账户类型
	TThostFtdcHedgeFlagType	TradingCodeType;
	///第一腿单腿乘数
	TThostFtdcLegMultipleType	Leg1Multiple;
	///第二腿单腿乘数
	TThostFtdcLegMultipleType	Leg2Multiple;
	///多头止盈Tick数
	TThostFtdcTickAmountType	LongTakeProfitTick;
	///空头止盈Tick数
	TThostFtdcTickAmountType	ShortTakeProfitTick;
	///多头止损
	TThostFtdcPriceType	LongStopLoss;
	///空头止损
	TThostFtdcPriceType	ShortStopLoss;
	///多头止盈
	TThostFtdcPriceType	LongTakeProfit;
	///空头止盈
	TThostFtdcPriceType	ShortTakeProfit;
	///第一腿空头今日持仓
	TThostFtdcVolumeType	Leg1ShortTodayPosition;
	///第二腿多头今日持仓
	TThostFtdcVolumeType	Leg2LongTodayPosition;
	///第一腿多头今日持仓
	TThostFtdcVolumeType	Leg1LongTodayPosition;
	///第二腿空头今日持仓
	TThostFtdcVolumeType	Leg2ShortTodayPosition;
	///是否使用锁仓
	TThostFtdcBoolType	UseLockPosition;
};

///查询交易策略
struct CThostFtdcQryTradingStrategyField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
...
///债券利息
struct CThostFtdcBondInterestField
{
	///交易日
	TThostFtdcDateType	TradingDay;
	///交易所代码
	...
	TThostFtdcInstrumentIDType	InstrumentID;
	///利息
	TThostFtdcInterestType	Interest;
};

///查询债券利息
struct CThostFtdcQryBondInterestField
{
	///交易所代码
	TThostFtdcExchangeIDType	ExchangeID;
	///合约代码
...
///提交函数
struct CThostFtdcSubmitFunctionField
{
	///公式语法类型
	TThostFtdcFormulaSyntaxTypeType	FormulaSyntaxType;
	///公式类型
	TThostFtdcFormulaTypeType	FormulaType;
	///公式名称
	TThostFtdcFormulaNameType	FormulaName;
	///简称
	TThostFtdcShortNameType	ShortName;
	///返回类型
	TThostFtdcReturnTypeType	ReturnType;
	///用户文本
	TThostFtdcFormulaTextType	FormulaText;
};

///提交公式
struct CThostFtdcSubmitFormulaField
{
	///公式语法类型
	TThostFtdcFormulaSyntaxTypeType	FormulaSyntaxType;
	///公式类型
...
///编译代码
struct CThostFtdcCompileCodeField
{
	///公式语法类型
	TThostFtdcFormulaSyntaxTypeType	FormulaSyntaxType;
	///公式类型
	...
	TThostFtdcReturnTypeType	ReturnType;
	///编译信息
	TThostFtdcCompileMsgType	CompileMsg;
};

///执行公式
struct CThostFtdcExecuteFormulaField
{
	///公式语法类型
	TThostFtdcFormulaSyntaxTypeType	FormulaSyntaxType;
	///公式类型
...
///投资者风控参数
struct CThostFtdcInvestorRiskParamField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
	TThostFtdcInvestorIDType	InvestorID;
	///相对风险比率
	TThostFtdcRatioType	RelatedRiskRatio;
	///绝对风险资金金额
	TThostFtdcMoneyType	AbsRiskAmount;
	///投资者风险操作
	TThostFtdcInvestorRiskOperationType	InvestorRiskOperation;
	///描述
	TThostFtdcDescriptionType	Description;
};

///查询投资者风控参数
struct CThostFtdcQryInvestorRiskParamField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
...
///投资者撤单计数器
struct CThostFtdcInvestorOrderActionCountField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
	...
	TThostFtdcInstrumentIDType	InstrumentID;
	///最大撤单次数
	TThostFtdcVolumeType	MaxActionCount;
	///撤单次数
	TThostFtdcVolumeType	ActionCount;
	///交易日
	TThostFtdcDateType	TradingDay;
};

///查询投资者撤单计数器
struct CThostFtdcQryInvestorOrderActionCountField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
...
///相关投资者
struct CThostFtdcRelatedInvestorField
{
	///经纪公司代码
	TThostFtdcBrokerIDType	BrokerID;
	///投资者代码
	TThostFtdcInvestorIDType	InvestorID;
	///相关投资者代码
	TThostFtdcInvestorIDType	RelatedInvestorID;
	///是否活跃
	TThostFtdcBoolType	IsActive;
	///数量比率
	TThostFtdcRatioType	VolumeRatio;
	///数量值率
	TThostFtdcVolumeType	VolumeValue;
	///包含的合约代码
	TThostFtdcInstrumentIDType	IncludeProduct;
	///排除的合约代码
	TThostFtdcInstrumentIDType	ExcludeProduct;
	///分数数量比率
	TThostFtdcRatioType	SingleVolumeRatio;
};
