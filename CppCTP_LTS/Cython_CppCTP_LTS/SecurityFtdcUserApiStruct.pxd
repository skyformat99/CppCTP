...
cdef extern from "SecurityFtdcUserApiStruct.h":
    ...
    ###交易所
    cdef struct CSecurityFtdcExchangeField:
    ...
    ###产品
    cdef struct CSecurityFtdcProductField:
    ...
    ###合约
    cdef struct CSecurityFtdcInstrumentField:
    ...
    ###经纪公司
    cdef struct CSecurityFtdcBrokerField:
    ...
    ###会员编码和经纪公司编码对照表
    cdef struct CSecurityFtdcPartBrokerField:
    ...
    ###投资者
    cdef struct CSecurityFtdcInvestorField:
    ...
    ###交易编码
    cdef struct CSecurityFtdcTradingCodeField:
    ...
    ###管理用户
    cdef struct CSecurityFtdcSuperUserField:
    ...
    ###管理用户功能权限
    cdef struct CSecurityFtdcSuperUserFunctionField:
    ...
    ###经纪公司用户
    cdef struct CSecurityFtdcBrokerUserField:
    ...
    ###经纪公司用户功能权限
    cdef struct CSecurityFtdcBrokerUserFunctionField:
    ...
    ###资金账户
    cdef struct CSecurityFtdcTradingAccountField:
    ...
    ###禁止登录用户
    cdef struct CSecurityFtdcLoginForbiddenUserField:
    ...
    ###深度行情
    cdef struct CSecurityFtdcDepthMarketDataField:
    ...
    ###投资者合约交易权限
    cdef struct CSecurityFtdcInstrumentTradingRightField:
    ...
    ###投资者持仓明细
    cdef struct CSecurityFtdcInvestorPositionDetailField:
    ...
    ###债券利息
    cdef struct CSecurityFtdcBondInterestField:
    ...
    ###市值配售信息
    cdef struct CSecurityFtdcMarketRationInfoField:
    ...
    ###合约手续费率
    cdef struct CSecurityFtdcInstrumentCommissionRateField:
    ...
    ###余券信息
    cdef struct CSecurityFtdcExcessStockInfoField:
    ...
    ###ETF合约
    cdef struct CSecurityFtdcETFInstrumentField:
    ...
    ###ETF股票篮
    cdef struct CSecurityFtdcETFBasketField:
    ...
    ###OF合约
    cdef struct CSecurityFtdcOFInstrumentField:
    ...
    ###SF合约
    cdef struct CSecurityFtdcSFInstrumentField:
    ...
    ###合约单手保证金
    cdef struct CSecurityFtdcInstrumentUnitMarginField:
    ...
    ###期权资金限制参数
    cdef struct CSecurityFtdcOptionsFundLimitParamField:
    ...
    ###投资者期权持仓
    cdef struct CSecurityFtdcInvestorOptionsPositionField:
    ...
    ###预交割信息
    cdef struct CSecurityFtdcPreDelivInfoField:
    ...
    ###可融券分配信息
    cdef struct CSecurityFtdcCreditStockAssignInfoField:
    ...
    ###可融资分配信息
    cdef struct CSecurityFtdcCreditCashAssignInfoField:
    ...
    ###证券折算率
    cdef struct CSecurityFtdcConversionRateField:
    ...
    ###历史信用负债信息
    cdef struct CSecurityFtdcHisCreditDebtInfoField:
    ...
    ###行情静态信息
    cdef struct CSecurityFtdcMarketDataStaticInfoField:
    ...
    ###到期回购信息
    cdef struct CSecurityFtdcExpireRepurchInfoField:
    ...
    ###债券质押为标准券比例
    cdef struct CSecurityFtdcBondPledgeRateField:
    ...
    ###债券质押代码对照关系
    cdef struct CSecurityFtdcPledgeBondField:
    ...
    ###港股基本信息
    cdef struct CSecurityFtdcHKBasicInfoField:
    ...
    ###平台状态信息
    cdef struct CSecurityFtdcPlatformStateInfoField:
    ...
    ###交易所交易员报盘机
    cdef struct CSecurityFtdcTraderOfferField:
    ...
    ###交易所行情报盘机
    cdef struct CSecurityFtdcMDTraderOfferField:
    ...
    ###前置状态
    cdef struct CSecurityFtdcFrontStatusField:
    ...
    ###用户会话
    cdef struct CSecurityFtdcUserSessionField:
    ...
    ###报单
    cdef struct CSecurityFtdcOrderField:
    ...
    ###报单操作
    cdef struct CSecurityFtdcOrderActionField:
    ...
    ###错误报单
    cdef struct CSecurityFtdcErrOrderField:
    ...
    ###错误报单操作
    cdef struct CSecurityFtdcErrOrderActionField:
    ...
    ###成交
    cdef struct CSecurityFtdcTradeField:
    ...
    ###投资者持仓
    cdef struct CSecurityFtdcInvestorPositionField:
    ...
    ###出入金同步
    cdef struct CSecurityFtdcSyncDepositField:
    ...
    ###投资者持仓调整
    cdef struct CSecurityFtdcAdjustInvestorPositionField:
    ...
    ###停牌期权标的信息
    cdef struct CSecurityFtdcHaltOptionsTargetField:
    ...
    ###查询交易所
    cdef struct CSecurityFtdcQryExchangeField:
    ...
    ###查询产品
    cdef struct CSecurityFtdcQryProductField:
    ...
    ###查询合约
    cdef struct CSecurityFtdcQryInstrumentField:
    ...
    ###查询经纪公司
    cdef struct CSecurityFtdcQryBrokerField:
    ...
    ###查询经纪公司会员代码
    cdef struct CSecurityFtdcQryPartBrokerField:
    ...
    ###查询投资者
    cdef struct CSecurityFtdcQryInvestorField:
    ...
    ###查询交易编码
    cdef struct CSecurityFtdcQryTradingCodeField:
    ...
    ###查询管理用户
    cdef struct CSecurityFtdcQrySuperUserField:
    ...
    ###查询管理用户功能权限
    cdef struct CSecurityFtdcQrySuperUserFunctionField:
    ...
    ###查询经纪公司用户
    cdef struct CSecurityFtdcQryBrokerUserField:
    ...
    ###查询经纪公司用户权限
    cdef struct CSecurityFtdcQryBrokerUserFunctionField:
    ...
    ###查询资金账户
    cdef struct CSecurityFtdcQryTradingAccountField:
    ...
    ###查询禁止登录用户
    cdef struct CSecurityFtdcQryLoginForbiddenUserField:
    ...
    ###查询行情
    cdef struct CSecurityFtdcQryDepthMarketDataField:
    ...
    ###查询合约交易权限
    cdef struct CSecurityFtdcQryInstrumentTradingRightField:
    ...
    ###查询投资者持仓明细
    cdef struct CSecurityFtdcQryInvestorPositionDetailField:
    ...
    ###查询债券利息
    cdef struct CSecurityFtdcQryBondInterestField:
    ...
    ###查询市值配售信息
    cdef struct CSecurityFtdcQryMarketRationInfoField:
    ...
    ###查询合约手续费率
    cdef struct CSecurityFtdcQryInstrumentCommissionRateField:
    ...
    ###查询余券信息
    cdef struct CSecurityFtdcQryExcessStockInfoField:
    ...
    ###查询投资者帐户关系
    cdef struct CSecurityFtdcQryInvestorAccountField:
    ...
    ###查询ETF合约
    cdef struct CSecurityFtdcQryETFInstrumentField:
    ...
    ###查询ETF股票篮
    cdef struct CSecurityFtdcQryETFBasketField:
    ...
    ###查询OF合约
    cdef struct CSecurityFtdcQryOFInstrumentField:
    ...
    ###查询SF合约
    cdef struct CSecurityFtdcQrySFInstrumentField:
    ...
    ###查询合约单手保证金
    cdef struct CSecurityFtdcQryInstrumentUnitMarginField:
    ...
    ###查询期权资金限制参数
    cdef struct CSecurityFtdcQryOptionsFundLimitParamField:
    ...
    ###查询投资者期权持仓
    cdef struct CSecurityFtdcQryInvestorOptionsPositionField:
    ...
    ###查询预交割信息
    cdef struct CSecurityFtdcQryPreDelivInfoField:
    ...
    ###查询可融券分配信息
    cdef struct CSecurityFtdcQryCreditStockAssignInfoField:
    ...
    ###查询可融资分配信息
    cdef struct CSecurityFtdcQryCreditCashAssignInfoField:
    ...
    ###查询证券折算率
    cdef struct CSecurityFtdcQryConversionRateField:
    ...
    ###查询历史信用负债信息
    cdef struct CSecurityFtdcQryHisCreditDebtInfoField:
    ...
    ###查询行情静态信息
    cdef struct CSecurityFtdcQryMarketDataStaticInfoField:
    ...
    ###查询到期回购信息
    cdef struct CSecurityFtdcQryExpireRepurchInfoField:
    ...
    ###查询债券质押为标准券比例
    cdef struct CSecurityFtdcQryBondPledgeRateField:
    ...
    ###查询债券质押代码对照关系
    cdef struct CSecurityFtdcQryPledgeBondField:
    ...
    ###查询港股基本信息
    cdef struct CSecurityFtdcQryHKBasicInfoField:
    ...
    ###查询交易员报盘机
    cdef struct CSecurityFtdcQryTraderOfferField:
    ...
    ###查询行情报盘机
    cdef struct CSecurityFtdcQryMDTraderOfferField:
    ...
    ###查询前置状态
    cdef struct CSecurityFtdcQryFrontStatusField:
    ...
    ###查询用户会话
    cdef struct CSecurityFtdcQryUserSessionField:
    ...
    ###查询报单
    cdef struct CSecurityFtdcQryOrderField:
    ...
    ###查询报单操作
    cdef struct CSecurityFtdcQryOrderActionField:
    ...
    ###查询错误报单
    cdef struct CSecurityFtdcQryErrOrderField:
    ...
    ###查询错误报单操作
    cdef struct CSecurityFtdcQryErrOrderActionField:
    ...
    ###查询成交
    cdef struct CSecurityFtdcQryTradeField:
    ...
    ###查询投资者持仓
    cdef struct CSecurityFtdcQryInvestorPositionField:
    ...
    ###查询出入金流水
    cdef struct CSecurityFtdcQrySyncDepositField:
    ...
    ###用户口令变更
    cdef struct CSecurityFtdcUserPasswordUpdateField:
    ...
    ###资金账户口令变更域
    cdef struct CSecurityFtdcTradingAccountPasswordUpdateField:
    ...
    ###手工同步用户动态令牌
    cdef struct CSecurityFtdcManualSyncBrokerUserOTPField:
    ...
    ###经纪公司用户口令
    cdef struct CSecurityFtdcBrokerUserPasswordField:
    ...
    ###资金账户口令域
    cdef struct CSecurityFtdcTradingAccountPasswordField:
    ...
    ###用户权限
    cdef struct CSecurityFtdcUserRightField:
    ...
    ###投资者账户
    cdef struct CSecurityFtdcInvestorAccountField:
    ...
    ###用户IP
    cdef struct CSecurityFtdcUserIPField:
    ...
    ###用户动态令牌参数
    cdef struct CSecurityFtdcBrokerUserOTPParamField:
    ...
    ###用户登录应答
    cdef struct CSecurityFtdcRspUserLoginField:
    ...
    ###用户登出请求
    cdef struct CSecurityFtdcUserLogoutField:
    ...
    ###全部登出信息
    cdef struct CSecurityFtdcLogoutAllField:
    ...
    ###强制交易员退出
    cdef struct CSecurityFtdcForceUserLogoutField:
    ...
    ###经纪公司用户激活
    cdef struct CSecurityFtdcActivateBrokerUserField:
    ...
    ###认证随机码
    cdef struct CSecurityFtdcAuthRandCodeField:
    ...
    ###输入报单
    cdef struct CSecurityFtdcInputOrderField:
    ...
    ###输入报单操作
    cdef struct CSecurityFtdcInputOrderActionField:
    ...
    ###指定的合约
    cdef struct CSecurityFtdcSpecificInstrumentField:
    ...
    ###指定的交易所
    cdef struct CSecurityFtdcSpecificExchangeField:
    ...
    ###行情基础属性
    cdef struct CSecurityFtdcMarketDataBaseField:
    ...
    ###行情静态属性
    cdef struct CSecurityFtdcMarketDataStaticField:
    ...
    ###行情最新成交属性
    cdef struct CSecurityFtdcMarketDataLastMatchField:
    ...
    ###行情最优价属性
    cdef struct CSecurityFtdcMarketDataBestPriceField:
    ...
    ###行情申买二、三属性
    cdef struct CSecurityFtdcMarketDataBid23Field:
    ...
    ###行情申卖二、三属性
    cdef struct CSecurityFtdcMarketDataAsk23Field:
    ...
    ###行情申买四、五属性
    cdef struct CSecurityFtdcMarketDataBid45Field:
    ...
    ###行情申卖四、五属性
    cdef struct CSecurityFtdcMarketDataAsk45Field:
    ...
    ###行情更新时间属性
    cdef struct CSecurityFtdcMarketDataUpdateTimeField:
    ...
    ###成交均价
    cdef struct CSecurityFtdcMarketDataAveragePriceField:
    ...
    ###行情交易所代码属性
    cdef struct CSecurityFtdcMarketDataExchangeField:
    ...
    ###信息分发
    cdef struct CSecurityFtdcDisseminationField:
    ...
    ###资金转账输入
    cdef struct CSecurityFtdcInputFundTransferField:
    ...
    ###资金转账
    cdef struct CSecurityFtdcFundTransferField:
    ...
    ###资金转账查询请求
    cdef struct CSecurityFtdcQryFundTransferSerialField:
    ...
    ###资金内转
    cdef struct CSecurityFtdcFundInterTransferField:
    ...
    ###资金内转流水
    cdef struct CSecurityFtdcFundInterTransferSerialField:
    ...
    ###资金内转流水查询请求
    cdef struct CSecurityFtdcQryFundInterTransferSerialField:
    ...
    ###资金回拨输入信息
    cdef struct CSecurityFtdcInputFundBackInfoField:
    ...
    ###资金回拨信息
    cdef struct CSecurityFtdcFundBackInfoField:
    ...
    ###获取数据库信息
    cdef struct CSecurityFtdcFetchDBInfoField:
    ...
    ###MD用户信息
    cdef struct CSecurityFtdcMDUserInfoField:
